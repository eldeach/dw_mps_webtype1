...
function getMachineList (app) {
    app.get('/getmachinelist', async function ( req, res ) {
        ...
        SELECT
            ...
            THIS_TBL.periodic_mng_1y_mt AS periodic_mng_1y_mt,
            THIS_TBL.periodic_mng_mt AS periodic_mng_mt,
            DOC_L.mc_periodic_1y_qual AS mc_periodic_1y_qual,
            ...
            DOC_M.mc_periodic_1y_mt AS mc_periodic_1y_mt,
        ...
        FROM
            ...
            (SELECT
                ...
                CONCAT('[',
                    GROUP_CONCAT(
                    CONCAT('{',
                        CONCAT('"mc_periodic_1y_qual_id":"', if(ISNULL(mc_periodic_1y_qual_id),'',mc_periodic_1y_qual_id),'",'),
                        CONCAT('"doc_no":"', if(ISNULL(doc_no),'',doc_no),'",'),
                        CONCAT('"doc_rev_no":', if(ISNULL(doc_rev_no),null,doc_rev_no),','),
                        CONCAT('"doc_title":"', if(ISNULL(doc_title),'',doc_title),'",'),
                        CONCAT('"doc_author":"', if(ISNULL(doc_author),'',doc_author),'",'),
                        ...
                        CONCAT('"doc_approval_date":"', if((doc_approval_date < '1970-01-02' OR doc_approval_date IS NULL), '', date_format(doc_approval_date, '%Y-%m-%d')),'"'),
                    '}') SEPARATOR ","),
                ']') AS mc_periodic_1y_qual
            FROM tb_mc_periodic_1y_qual GROUP BY mc_periodic_1y_qual_id) AS DOC_L ON THIS_TBL.mc_periodic_1y_qual_id = DOC_L.mc_periodic_1y_qual_id
            LEFT OUTER JOIN
            (SELECT
                ...
                CONCAT('[',
                    GROUP_CONCAT(
                        CONCAT('{',
                        CONCAT('"mc_periodic_1y_mt_id":"', if(ISNULL(mc_periodic_1y_mt_id),'',mc_periodic_1y_mt_id),'",'),
                        CONCAT('"doc_no":"', if(ISNULL(doc_no),'',doc_no),'",'),
                        CONCAT('"doc_rev_no":', if(ISNULL(doc_rev_no),null,doc_rev_no),','),
                        CONCAT('"doc_title":"', if(ISNULL(doc_title),'',doc_title),'",'),
                        CONCAT('"doc_author":"', if(ISNULL(doc_author),'',doc_author),'",'),
                        ...
                        CONCAT('"doc_approval_date":"', if((doc_approval_date < '1970-01-02' OR doc_approval_date IS NULL), '', date_format(doc_approval_date, '%Y-%m-%d')),'"'),
                    '}') SEPARATOR ","),
                ']') AS mc_periodic_1y_mt
            FROM tb_mc_periodic_1y_mt GROUP BY mc_periodic_1y_mt_id) AS DOC_M ON THIS_TBL.mc_periodic_1y_mt_id = DOC_M.mc_periodic_1y_mt_id
